...
const RegionFilterBackup = () => {
    ...
    const onCheckRegion = (e) => {
        ...
        if (checked) {
            setCheckedRegions([...checkedRegions, value]);
          } else {
            setCheckedRegions(checkedRegions.filter((region) => region !== value));
          }
...
export default RegionFilterBackup;